    ...
    public class RapierSettings : ScriptableObject
    {
        ...
        public static RapierSettings GetOrCreateSettings()
        {
            ...
            if (instance == null)
            {
                ...
                instance.PhysicsTicksPerSecond = 50.0f;
                instance.NumSolverIterations = 4;
                instance.NumInternalPgsIterations = 1;
                instance.NumAdditionalFrictionIterations = 0;
                instance.NumInternalStabilizationIterations = 2;
                instance.MaxCcdSubsteps = 1;
                instance.ContactDampingRatio = 5.0f;
                instance.ContactNaturalFrequency = 30.0f;
                instance.JointNaturalFrequency = 1.0e6f;
                instance.JointDampingRatio = 1.0f;
                instance.LengthUnit = 1.0f;
                instance.NormalizedPredictionDistance = 0.002f;
                instance.NormalizedMaxCorrectiveVelocity = 10.0f;
#if UNITY_EDITOR
